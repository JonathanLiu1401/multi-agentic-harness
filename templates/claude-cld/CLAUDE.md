...
`http://127.0.0.1:8317`, 64k context (`CLAUDE_CODE_MAX_CONTEXT_TOKENS` and
`CLAUDE_CODE_AUTO_COMPACT_WINDOW` both 64000).

You are DeepSeek (V3 / R1). When `/claude-manages-codex` (Multi-Agentic
Harness) is active:
